...
import database.{BoutDao, GameDao}
...
@Singleton
class BoutController @Inject()(boutPersister: BoutPersister, gameDao: GameDao, boutDao: BoutDao, cc: ControllerComponents)(implicit ec: ExecutionContext) extends AbstractController(cc) {
  ...
  def getGamesByBoutId(x: Int) = Action.async {
